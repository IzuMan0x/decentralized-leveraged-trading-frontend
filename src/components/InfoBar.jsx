      ...
      {mounted && (
        <nav className="bg-gray-700 border-gray-200 dark:bg-gray-900 rounded-lg m-2 md:shrink-0">
          <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div
              className="items-center justify-between w-full md:flex md:w-auto md:order-1 text-xs"
              id="navbar-cta"
            >
              <ul className="flex flex-col flex-wrap font-medium p-2 md:p-3 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
                  <div class="block py-2 pl-2 pr-4  rounded md:bg-transparent text-green-700 md:p-0 md:dark:text-green-600 hover:text-green-400">
                ...
                <li>
                  <div
                    className="block py-2 pl-2 pr-4 text-red-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-red-500 md:p-0 md:dark:hover:text-red-500 dark:text-red-700 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                    aria-current="page"
                  >
