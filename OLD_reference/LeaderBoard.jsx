...
async function LeaderBoard({ standings }) {
  ...
  //console.log("from the leaderboard", standings);
  const leaderboardData = standings;
    ...
    <>
      ...
      <div className="relative overflow-x-auto m-10 rounded-lg">
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400 ">
          ...
          {!dataLoading &&
            Object.keys(await leaderboardData).map((key, index) => {
